...
class _TalabatState extends State<Talabat> {
  ...
  TextEditingController canclecontroler = TextEditingController();
                      ...
                      child: Row(
                        ...
                        children: [
                          Column(
                            children: [
                              StreamBuilder(
                                stream: FirebaseFirestore.instance.collection('ordersources').snapshots(),
                              ...
                              StreamBuilder(
                                stream: FirebaseFirestore.instance.collection('shippingtypes').snapshots(),
                                builder: (_, AsyncSnapshot<QuerySnapshot> snapshot) {
                                  var items = snapshot.data!.docs;
                                  nn.clear();
                                  for(int i = 0;i<items.length;i++){
                        ...
                        DefaultTable(
                          ...
                          rows: dataId
                            ...
                            DataCell(PopupMenuButton(
                              ...
                              itemBuilder: (context) =>
                              [
                                result[data]!['orderstatus']=="طلب جديد"
                                    ?PopupMenuItem(
                                  value: 1,
                                  ...
                                  onTap: () async{
                                    ...
                                    :result[data]!['orderstatus']=="طلب مؤكد"
                                    ?PopupMenuItem(
                                  value: 2,
                                  ...
                                  onTap: () async{
                                    ...
                                    try{
                                      ...
                                      if(result[data]!["orderstatus"]=="تم شحن"||
                                          result[data]!["orderstatus"]=="ملغى")
                                      {
                                        ...
                                        result[data]!["phonenumber1"];
                                        print("14");
                                        pro.shippingfees = result[data]!["shippingfees"];
                                        pro.shippingtyp= result[data]!["shippingtype"];
                                        pro.routenumber = result[data]!["routenumber"];
                                        pro.courriers = result[data]!["courrier"];
                                        print("15");
                                        QuerySnapshot qn = await FirebaseFirestore
                                            .instance
                                            .collection(
                                    ...
                                    :result[data]!['orderstatus']=="تم شحن"
                                    ?PopupMenuItem(
                                  value: 3,
                                  ...
                                  onTap: () async{
                                    ...
                                    pro.courriers = result[data]!["courrier"];
                                    print("19");
                                    pro.orderstatusdate = result[data]!["statusdate"]
                                        .toString();
                                    print("20");
                                    pro.treasury = result[data]!["treasury"];
                                    print("21");
                                    QuerySnapshot qn = await FirebaseFirestore
                                        .instance
                                        .collection(
                                ...
                                result[data]!['orderstatus']=="تم التحصيل"||result[data]!["orderstatus"]=="ملغى"
                                    ?PopupMenuItem(
                                  value: 5,
                                  child: Text(' '),
                                  onTap: () async{},
                                  ...
                                  onTap: () {
                                    if(result[data]!["orderstatus"]=="ملغى"){
                                      final snackBar =  SnackBar(
                                        content: Text('Order already canceled '),);
                                ...
                                result[data]!["orderstatus"]=="ملغى"||result[data]!["orderstatus"]=="تم التحصيل"?PopupMenuItem(
                                  value: 5,
                                  child: Text(' '),
                                  onTap: () async{},
                                ):PopupMenuItem(
                                  ...
                                  onTap: () async{
                                    ...
                                    result[data]!["netamount"];
                                    print("9");
                                    pro.orderstatus = result[data]!["orderstatus"].toString();
                                    print("10");
                                    pro.ordersource =
                                    result[data]!["ordersource"];
                                    print("11");
                            ...
                            DataCell(Text(
                              result[data]![
                              'shippingtype'],
                              style: TextStyle(fontSize: getProportionateScreenWidth(3)),
                            )),
                            DataCell(Text(
                              result[data]![
                              'postpone']
                            ...
                            DataCell(
                              Container(
                                  color: result[data]!['orderstatus']=="طلب جديد"
                                      ?Color(0xff82225E)
                                      :result[data]!['orderstatus']=="تم التحصيل"
                                      ?Colors.grey
                                      :result[data]!['orderstatus']=="ملغي"||result[data]!['orderstatus']=="رفض الاستلام"
                                      ?Colors.red
                                      :result[data]!['orderstatus']=="تم شحن"
                                      ?Color(0xffB8E1CD)
                                      :Colors.yellow,
                        ...
                        decline
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Botton(color: Colors.black, title: "Save", onTap: ()async{

                                if(oStat == "ملغي"){
                                  final snackBar =  SnackBar(
                                    content: const Text('تم الالغآ من قبل'),);
                                  ...
                                  await FirebaseFirestore.instance.collection("supplychain").doc(id).update(
                                      {
                                        "orderstatus":"ملغي",
                                        "cancellationnote":canclecontroler.text
                                      });
                                  setState(() {
                                  ...
                                  await FirebaseFirestore.instance.collection("supplychain").doc(id).update(
                                      {
                                        ...
                                        "postpone":FieldValue.increment(1)
                                      });
                                  setState(() {
