...
class _AddCatState extends State<AddCat> {
  ...
  Widget build(BuildContext context) {
    ...
    chose1 = pro.measurement;
    chose2 = pro.type;
    chose3 = pro.productionBranch;
    controller1.text = pro.name ?? '';
    controller2.text = pro.minLimit ?? '';
    controller3.text = pro.firstPrice ?? '';
    controller4.text = pro.price ?? '';
    print(pro.isPriceEdit);
    return SafeArea(
        child: Scaffold(
          body: Row(
